...
namespace WIRVINGJIMENEZEFP6232.Models
{
 ...
 //               optionsBuilder.UseSqlServer("SERVER=.; DATABASE=AnswersDB; INTEGRATED SECURITY=FALSE; USER ID=MyWirvingJimenezEFP6232; PASSWORD=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<General>(entity =>
            {
                entity.HasKey(e => e.Idconfig)
                    .HasName("PK__General__3E2AEF2A39556503");
